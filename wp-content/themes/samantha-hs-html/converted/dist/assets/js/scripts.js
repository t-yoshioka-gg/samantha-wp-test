...
(function ($) {
  ...
  growApp.prototype.floatingHidden = function () {
    var $button = $(".c-button__floating");
    if ($button.length <= 0) {
      return false;
    }
    var offerOffset = $(".l-offer").offset().top;
    var windowHeight = $(window).height();
    $(window).scroll(function (){
      var scroll = $(this).scrollTop();
      if (scroll > offerOffset - windowHeight + windowHeight / 5) {
